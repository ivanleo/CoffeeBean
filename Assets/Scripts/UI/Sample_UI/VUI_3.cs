...
/// 请填写[ 类的作用 ]
/// </summary>
[CUIInfo ( PrefabName = "Resources/UI/Prefab/UI_3.prefab", IsSigleton = true, IsAnimationUI = true, Description = " 请填写[ 类的作用 ] " )]
public class VUI_3 : CUIBase<VUI_3>
{
    /// <summary>
    /// 请填写[ 成员意义 ]
    /// </summary>
